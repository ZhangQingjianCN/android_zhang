package com.taoxue.myapplication8;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button exit_button = (Button) findViewById(R.id.back_button);
        ...
        shopping_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, R.string.out_shopping, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.settings_item) {
            ...
            Toast.makeText(MainActivity.this, R.string.remove, Toast.LENGTH_SHORT).show();
            return true;
        }
